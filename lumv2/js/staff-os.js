...
window.StaffOS = (function () {
  ...
  ───────────────────────────────────────── */
  var APP_REGISTRY = [
    { id: "gate",       labelKey: "app.gate",       iconText: "입", group: "main", color: "#fff7fb", renderer: "native" },
    { id: "queue",      labelKey: "app.queue",      iconText: "대", group: "main", color: "#fff7fb", renderer: "native" },
    { id: "fanCheck",   labelKey: "app.fanCheck",   iconText: "팬", group: "main", color: "#fff7fb", renderer: "native" },
    { id: "cheki",      labelKey: "app.cheki",      iconText: "촬영", group: "main", color: "#fff7fb", renderer: "native" },
    ...
    { id: "attendance", labelKey: "app.attendance", iconText: "출", group: "main", color: "#fff7fb", renderer: "native" },
    { id: "memo",       labelKey: "app.memo",       iconText: "톡", group: "main", color: "#fff7fb", renderer: "native" },
    { id: "homeworkCheki", labelKey: "app.homeworkCheki", iconText: "숙", group: "more", color: "#fff7fb", renderer: "native" },
    { id: "caution",       labelKey: "app.caution", iconText: "주의", group: "more", color: "#fff7fb", renderer: "native" },
    { id: "notice",        labelKey: "app.notice", iconText: "공지", group: "more", color: "#fff7fb", renderer: "placeholder" },
    { id: "booth",         labelKey: "app.guide", iconText: "가이드", group: "more", color: "#fff7fb", renderer: "native" },
    { id: "pointAdjust",   labelKey: "app.pointAdjust", iconText: "정정", group: "more", color: "#fff7fb", renderer: "native" },
    { id: "staffAttendance",labelKey:"app.staffAttendance",iconText:"출석",group:"more",color:"#fff7fb",renderer:"native" },
    { id: "staffLog",      labelKey: "app.staffLog", iconText: "LOG", group: "more", color: "#fff7fb", renderer: "placeholder" },
    { id: "settings",      labelKey: "app.settings", iconText: "⚙", group: "more", color: "#fff7fb", renderer: "placeholder" },
    { id: "profile",       labelKey: "app.profile", iconText: "MY", group: "more", color: "#fff7fb", renderer: "placeholder" }
  ];
  /* ─────────────────────────────────────────
     Today 더미 데이터
     실제 API 붙이면 이 블록만 교체
  ...
  function _applyAppWindowState(appId) {
    ...
    els.appWindow.classList.remove("is-attendance-app", "is-gate-app", "is-point-app", "is-caution-app", "is-queue-app", "is-cheki-app", "is-timer-app", "is-fan-check-app", "is-point-adjust-app", "is-homework-cheki-app", "is-guide-app", "is-memo-app", "is-memo-room", "app-overview-snapshot-window");
  ...
  function _closeAppWindow(options) {
    ...
    if (els.appWindow) {
      els.appWindow.classList.remove("is-open", "is-attendance-app", "is-gate-app", "is-point-app", "is-caution-app", "is-queue-app", "is-cheki-app", "is-timer-app", "is-fan-check-app", "is-point-adjust-app", "is-homework-cheki-app", "is-guide-app", "is-memo-app", "is-memo-room", "app-overview-snapshot-window");
