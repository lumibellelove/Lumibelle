(function () {
  ...
  var TASKS = [
    ...
    {
      id: 'hc-003', member: '루미벨', title: '숙제 체키', taskLabel: '토끼 포즈',
    ...
    {
      id: 'hc-004', member: '루미벨', title: '숙제 체키', taskLabel: '리본 포즈',
  ...
  function renderHomeworkChekiPreviewNotice() {
    return '<section class="v2-dev-inline-notice homework-cheki-preview-notice">' +
      '<strong>루미폰 V2 개발중인 화면이에요</strong>' +
      '<p>숙제체키 접수는 이번 페이지에서 진행하지 않아요.</p>' +
    '</section>';
  }
  ...
  function renderHomeworkChekiListInner() {
    ...
    return [
      ...
      '<section class="homework-cheki-title-panel">',
        ...
        '<span class="homework-cheki-title-mark" aria-hidden="true"></span>',
      '</section>',
      renderHomeworkChekiPreviewNotice(),
